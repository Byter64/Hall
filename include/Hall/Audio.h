...
namespace Hall
{
	...
	void SetupMono(int channelID, const Sample* data, int sampleCount, unsigned char volume = 128);
	...
	/// <param name="volume">The channel's local volume. 0 is muted, 128 is the default, 255 is max</param>
	void SetupMono(int channelID, const Sample* data, int sampleCount, unsigned int loopStart, unsigned int loopEnd, unsigned char volume = 128);
	...
	/// <param name="volume">The channel's local volume. 0 is muted, 128 is the default, 255 is max</param>
	void SetupStereo(int channelID_left, int channelID_right, const Sample* data, int sampleCount, unsigned char volume = 128);
	...
	/// <param name="loopEnd">The index of the last sample of the loop (exclusive?)</param>
	/// <param name="volume">The channel's local volume. 0 is muted, 128 is the default, 255 is max</param>
	void SetupStereo(int channelID_left, int channelID_right, const Sample* data, int sampleCount, unsigned int loopStart, unsigned int loopEnd, unsigned char volume = 128);
	

	void Play(unsigned char channelSelect);	
	void Pause(unsigned char channelSelect);
	void SetData(unsigned char channelSelect, Sample* data);
